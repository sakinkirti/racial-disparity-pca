...
class DataUtil(object):
    ...
    @staticmethod
    def preprocess(datadir, modality, lesionMask, organMask, inext, outext, inputfoldername, outputfoldername,
                   configpath):
        ...
        for i, sb in enumerate(subfolders):
            ...
            if doResampling:
                ...
                resampledOrganMask = DataUtil.resampleimage(preprocessedMaskImg, toSpacing, origin,
                                                            interpolator=sitk.sitkNearestNeighbor)
                resampledOrganMask = sitk.Cast(resampledOrganMask, sitk.sitkUInt8)
                preprocessedMaskImg = resampledOrganMask
                lesionMaskImg = DataUtil.resampleimage(lesionMaskImg, toSpacing, origin,
                                                       interpolator=sitk.sitkNearestNeighbor)
