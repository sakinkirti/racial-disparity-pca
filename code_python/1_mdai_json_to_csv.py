...
sys.path.append("C:\\Users\\Jayas\\Downloads")
...
if __name__ == "__main__":
    ...
    filename = "/Users/sakinkirti/Programming/Python/CCIPD/RacialDisparityDataset/dicom and json/leo_121_african_american"
    ...
    m1 = m1[
        ['ExamNumber', 'labelId', 'StudyInstanceUID', 'SeriesInstanceUID', 'SOPInstanceUID', 'createdAt', 'updatedAt',
         'height', 'width', 'data', 'note', 'StudyName']]
    lgsdf = lgsdf[['labelId', 'LabelName', 'LabelGroup', 'annotationMode']]

    m2 = m1.merge(lgsdf, on='labelId')

    m2 = m2[
        ['ExamNumber', 'StudyInstanceUID', 'SeriesInstanceUID', 'SOPInstanceUID', 'labelId', 'LabelName', 'LabelGroup',
         'annotationMode', 'createdAt',
         'updatedAt', 'height', 'width', 'data', 'note', 'StudyName', ]]

    m2.to_csv(f'check_json_leo.csv', index=None)
