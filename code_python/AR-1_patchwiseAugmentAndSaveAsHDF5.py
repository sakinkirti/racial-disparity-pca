...
if __name__ == "__main__":
    ...
    labelsdf = pd.read_csv(fr"/Users/sakinkirti/Programming/Python/CCIPD/racial-disparity-pca/dataset/racial_disparity_filtered.csv")# .set_index("GGG (1-5)")
    labelsdf.to_csv('/Users/sakinkirti/Programming/Python/CCIPD/racial-disparity-pca/dataset/test.csv')
    ...
    for RAD in RAD_NAME:
        ...
        for j, name in enumerate(cases):
            ...
            lesionpath = Path(fr"dataset/lesion-masks/{RAD}/{patname}/")
            ...
            # Lesion loop
            outputfolder = fr"dataset/model-outputs/{hdf5path}" # change to wherever you are storing output hdf5 files
