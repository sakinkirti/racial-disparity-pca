...
from imageDataUtil import ImageDataUtil
...
main_path = '/Users/sakinkirti/Programming/Python/CCIPD/CA_clean'
num_images = 'many'
...
def main(type):
    if type == 'single':
        ...
        origin, spacing, direction = ImageDataUtil.get_image_data(img)
        ...
        for mask_path in mask_paths:
            ...
            ImageDataUtil.set_image_data(new_mask, origin, spacing, direction)
        ...
        for mask_path in mask_paths:
            mask = sitk.ReadImage(mask_path)
            mask_orig, mask_spacing, mask_direc = ImageDataUtil.get_image_data(mask)
        ...
        for dir in subdirs:
            ...
            mask_paths = glob.glob(f'{str(dir)}/LS1.nii.gz', recursive=True)
        ...
        for dir in subdirs:
            ...
            mask_paths = glob.glob(f'{dir}/LS1.nii.gz', recursive=True)
