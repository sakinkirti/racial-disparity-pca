function [outputvolume,standardization_map,scalefactends] = int_stdn_landmarks(inputvolume,templatevolume,varargin)
...
if dorescale
    inputvolume = round(rescale_range(inputvolume,0,511));
    templatevolume = round(rescale_range(templatevolume,0,511));
end
...
[standardization_map,scalefactends] = calcstdnmap(inputdata,templatedata,landmarks);
